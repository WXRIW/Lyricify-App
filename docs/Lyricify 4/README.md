...
- [自定义 API Client](CustomClient/Readme.zh-CN.md)
...
**注意：**
1. 步骤 5 中的歌词制作可参考 [Lyricify 4 歌词指南及标准](Lyrics.md)。  
...
1. 若切歌后 Lyricify 中的歌曲信息仍是上一首。
   1. 如果您是 Spotify Premium 用户，且是上一曲放完自动切到下一首，或是您手动点击下一首按钮进行切歌的，且是在运行 Lyricify 的设备上使用 Spotify 播放的
      ...
      3. 如果未连接，则需先修复 [Media Session 连接问题](#media-session-%E6%9C%AA%E8%BF%9E%E6%8E%A5)。
...
你也可以使用 Lyricify Lite 软件，它支持所有接入了 SMTC 的应用，如 Apple Music、QQ 音乐等，详见 [Lyricify Lite 使用指南](../Lyricify%20Lite/README.md)。
