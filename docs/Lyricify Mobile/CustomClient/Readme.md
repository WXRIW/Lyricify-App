> [!CAUTION]
> ## This tutorial has been migrated to [Lyricify Docs](https://docs.lyricify.app/en/lyricify-mobile/custom-api-client/). This legacy page is no longer maintained.
