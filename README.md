...
| :-: | :-: | :-: | :-: | :-: |
| [Lyricify 4](https://github.com/WXRIW/Lyricify-App#lyricify-4) | [4.2.28-release](https://github.com/WXRIW/Lyricify-App/releases/tag/v4.2.28) | 适用于 Spotify 用户</br>For Spotify users | Windows<sup><a href="#ref2">2</a></sup> | [点击查看</br>Click to view](/docs/Lyricify%204/README.md)<sup><a href="#ref6_en">6</a></sup> |
...
2. <span id="ref2">Lyricify 4、Lyricify 3 可借助 Wine 实现在 Linux 和 macOS 上运行。Lyricify 4 实现过程可能会比较繁琐，~需要您耐心尝试~我们已经在尝试让 Lyricify 通过 Wine 在 Linux 平台上运行，并争取稳定复现。您可以在 [Lyricify-on-Wine](https://github.com/Lyricify/Lyricify-on-Wine) 仓库下载软件包。在 M 系列芯片的 Mac 上，建议使用 Windows on ARM 虚拟机运行 Lyricify ARM64 版本以获得更好的体验。</span>  
...
2. <span id="ref2_en">Lyricify 4, Lyricify 3 can run on Linux and macOS via Wine. The installation process of Lyricify 4 may be cumbersome and requires your patience. **We are endeavoring to operate Lyricify via Wine on the Linux platform, striving for consistent reproduction. You may procure the software package from the [Lyricify-on-Wine](https://github.com/Lyricify/Lyricify-on-Wine) repository.** On Macs with M-series chips, it is recommended to use a Windows on ARM virtual machine to run the Lyricify ARM64 version for a better experience.</span>  
